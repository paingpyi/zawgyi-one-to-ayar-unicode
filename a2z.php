...
Version: 1.0
Screenshots:h ttp://i35.tinypic.com/dn1sgh.jpg & http://i37.tinypic.com/2li9bp4.jpg
*/
/*Language loader*/
...
h1, h2, h3, h4 { font-family:  Ayar Takhu, Ayar Kasone, Ayar Wazo, Ayar Juno, Ayar Kasone, Ayar Takhu, Ayar; text-rendering: optimizeLegibility;}
...
.otf a, #bm a {
	...
	color:white;
	font-family:  Ayar Takhu, Ayar Kasone, Trebuchet MS, Helvetica, sans-serif;
	font-weight: bold;
}
#bm a {
	font-weight: normal;
...
.btot a{
    text-decoration: none;
	color:white;
	font-family: Ayar, Ayar Takhu, Ayar Kasone, Trebuchet MS, Helvetica, sans-serif;
	font-weight: bold;
	}
.button-primary {
	font-family: Ayar, Ayar Takhu, Ayar Kasone, Trebuchet MS, Helvetica, sans-serif;
...
<![endif]-->
<script type="text/javascript" src="<?php bloginfo('wpurl'); ?>/wp-content/plugins/js/ayar2zawgyi/js/zgayar.mini.js"></script>
<script type="text/javascript" src="<?php bloginfo('wpurl'); ?>/wp-content/plugins/js/ayar2zawgyi/js/ayarzg.mini.js"></script>
