...
@font-face {
  font-family: 'Ayar';
  src: url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar.eot');
  src: local('Ayar'),
	url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar.woff') format('woff'),
    url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar.ttf') format('opentype'),
	url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar.svgz#webfontsnhuR0D6') format('svg'),
	url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar.svg#webfontsnhuR0D6') format('svg');
	font-weight: normal;
	font-style: normal;
...
@font-face {
  ...
  src: local('Ayar Kasone'),
	url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar_kasone.woff') format('woff'),
    url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar_kasone.ttf') format('opentype'),
	url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar_kasone.svgz#webfonty96Ct56S') format('svg'),
	url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar_kasone.svg#webfonty96Ct56S') format('svg');
	font-weight: bold;
	font-style: normal;
    unicode-range:U+1000-1097;
    text-rendering: optimizeLegibility;
...
@font-face {
  ...
  src: url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar_takhu.eot');
  src: local('Ayar Takhu'),
	url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar_takhu.woff') format('woff'),
    url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar_takhu.ttf') format('opentype'),
	url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar_takhu.svgz#webfontPga0uKRT') format('svg'),
	url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar_takhu.svg#webfontPga0uKRT') format('svg');
	font-weight: bold;
	font-style: normal;
    unicode-range:U+1000-1097;
    text-rendering: optimizeLegibility;
...
@font-face {
  ...
  src: url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar_juno.eot');
  src: local('Ayar Juno'),
	url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar_juno.woff') format('woff'),
    url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar_juno.ttf') format('opentype'),
	url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar_juno.svgz#webfontn0PFpV0z') format('svg'),
	url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar_juno.svg#webfontn0PFpV0z') format('svg');
	font-weight: bold;
	font-style: normal;
    unicode-range:U+1000-1097;
    text-rendering: optimizeLegibility;
...
@font-face {
  ...
  src: url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar_wazo.eot');
  src: local('Ayar Wazo'),
	url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar_wazo.woff') format('woff'),
    url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/Ayar_Wazo.ttf') format('opentype'),
	url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar_wazo.svgz#webfontFNSUhG79') format('svg'),
	url('<?php bloginfo('wpurl'); ?>/wp-content/plugins/ayar2zawgyi/eot/ayar_wazo.svg#webfontFNSUhG79') format('svg');
	font-weight: normal;
	font-style: normal;
    unicode-range:U+1000-1097;
    text-rendering: optimizeLegibility;
